...
import com.mrbysco.instrumentalmobs.client.render.model.ModelMaracaSpider;
...
public class MaracaSpiderEyesLayer<T extends MaracaSpiderEntity, M extends ModelMaracaSpider<T>> extends AbstractEyesLayer<T, M> {

...
public class ModelMaracaSpider extends ModelBase
{
    ...
    public void postRenderLeg(float scale, EnumHandSide side)
    {
        this.getLegForSide(side).postRender(scale);
    }

    protected ModelRenderer getLegForSide(EnumHandSide side)
    {
        return side == EnumHandSide.LEFT ? this.spiderLeg7 : this.spiderLeg8;

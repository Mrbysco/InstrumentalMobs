...
public class RenderSoundWaves extends RenderFireball{
	...
	public RenderSoundWaves(RenderManager renderManagerIn, float scaleIn) {
	...
	public static class Factory implements IRenderFactory<EntitySoundWaves> {
		@Override
		public Render<? super EntitySoundWaves> createRenderFor(RenderManager manager) {
			return new RenderSoundWaves(manager, scale);
		}
	}
}

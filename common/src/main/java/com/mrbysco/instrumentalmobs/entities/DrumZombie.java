...
public class DrumZombie extends Zombie implements IInstrumentalMobs {
	public DrumZombie(EntityType<? extends DrumZombie> type, Level level) {
		super(type, level);
	}

	@Override
	protected void registerGoals() {
		this.goalSelector.addGoal(4, new DrumZombie.AttackTurtleEggGoal(this, 1.0D, 3));
	...
	class AttackTurtleEggGoal extends RemoveBlockGoal {
		...
		public void playDestroyProgressSound(LevelAccessor level, BlockPos pos) {
			level.playSound((Player) null, pos, SoundEvents.ZOMBIE_DESTROY_EGG, SoundSource.HOSTILE, 0.5F, 0.9F + DrumZombie.this.random.nextFloat() * 0.2F);
		}

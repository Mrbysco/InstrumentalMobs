...
public class FrenchHornCreeperRenderer extends MobRenderer<FrenchHornCreeper, CreeperRenderState, FrenchHornCreeperModel> {
	...
	@Override
	public void extractRenderState(FrenchHornCreeper hornCreeper, CreeperRenderState state, float partialTick) {
		...
		if (state instanceof FrenchRenderState frenchRenderState) {
			itemModelResolver.updateForLiving(
					frenchRenderState.heldItem, hornCreeper.getMainHandItem(), ItemDisplayContext.THIRD_PERSON_RIGHT_HAND, false, hornCreeper
			);
		}
	}
